...
```
https://cdn.jsdelivr.net/gh/kysayo/redmine-graph@eeef135/dist/moca-react-graph.iife.js
```
...
(function() {
  function insertGraph() {
    ...
    script.src = 'https://cdn.jsdelivr.net/gh/kysayo/redmine-graph@eeef135/dist/moca-react-graph.iife.js';
