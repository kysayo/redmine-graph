...
```
https://cdn.jsdelivr.net/gh/kysayo/redmine-graph@5e344fc/dist/moca-react-graph.iife.js
```
...
(function() {
  function insertGraph() {
    ...
    script.src = 'https://cdn.jsdelivr.net/gh/kysayo/redmine-graph@5e344fc/dist/moca-react-graph.iife.js';
